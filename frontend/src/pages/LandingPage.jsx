      ...
      {batchPackages.length > 0 && (
        <section className="addons-section">
          <div className="batch-header">
              ...
              <div>
                <h2><Zap size={24} style={{ display: 'inline', verticalAlign: 'middle', marginRight: '8px', color: '#10b981' }} /> Consultas em Lote</h2>
            ...
            <div className="batch-description">
              <p>
                ...
                Cada resultado retornado = 1 crédito. <strong style={{color: '#10b981', display: 'flex', alignItems: 'center', gap: '6px', justifyContent: 'center', marginTop: '8px'}}><Sparkles size={16} /> Créditos comprados nunca expiram!</strong>
              </p>
              <div style={{
                marginTop: '15px',
                padding: '12px 16px',
                ...
                <strong style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Target size={18} style={{ color: '#10b981' }} /> 16+ filtros disponíveis:</strong> Razão Social, Nome Fantasia, CNAE Principal e Secundário, UF, Município, CEP, Bairro, Logradouro, Porte, Situação Cadastral, Matriz/Filial, Data de Abertura, Simples Nacional, MEI e muito mais!
              </div>
            </div>
